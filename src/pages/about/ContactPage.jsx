    ...
    <>
      <NavigationLayout>
        <section className="flex flex-col gap-5 items-center py-10">
          <h1 className="mt-20 text-2xl sm:text-4xl font-josefin font-semibold text-midnightBlue text-center drop-shadow-md">
            Contact Us
          </h1>
          <p className="mt-10 text-xl sm:text-2xl font-josefin font-semibold text-midnightBlue text-center drop-shadow-md">
            Any questions or remarks? Just write us a message!
          </p>
          <div className="flex flex-row gap-10 justify-center">
            <SignInInput placeholder={"Name"} />
            <SignInInput placeholder={"Email"} />
          </div>
          <Button className="bg-astrosNavy text-white hover:bg-chocolate p-3 rounded-md text-xl font-semibold font-josefin">
            Submit
          </Button>
        </section>
        <section className="bg-columbiaBlue py-10 px-10 flex flex-row gap-28 justify-center">
          <div className="flex flex-col items-center font-josefin font-semibold">
            <svg
          ...
          <div className="flex flex-col items-center font-josefin font-semibold">
            ...
            <p>1234 Pet Lane</p>
            <p>Suite 101 Hometown, AN 54321</p>
          </div>
          <div className="flex flex-col items-center font-josefin">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="45px"
              height="45px"
