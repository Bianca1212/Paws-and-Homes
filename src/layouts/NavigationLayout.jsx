...
export const NavigationLayout = ({ children }) => {
  ...
  return (
    <>
      ...
      {isMenuOpen && (
        <div className="m-0 absolute top-22 left-0 right-0 p-3 gap-4 sm:gap-5 flex flex-col sm:flex-row justify-center z-30 bg-midnightBlue">
          ...
          <NavigationButtonWithMenu
            ...
            menuItems={[{ name: "Online Appointment Form", url: "" }]}
          />
          <NavigationButtonWithMenu
            title={"ADOPTIONS"}
