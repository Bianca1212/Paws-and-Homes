  ...
  return (
    <>
      <div className="sticky top-0 z-50 bg-white w-full">
        <div className="relative flex justify-between items-center">
          <div className="flex flex-col sm:flex-row gap-6 sm:gap-10 items-center justify-center md:mx-5 mt-5 w-full">
            ...
            <div className="flex flex-row gap-2 items-center justify-center w-full">
              <h1 className="font-merriWeather rounded-lg text-center sm:max-w-xs md:max-w-sm lg:w-25 text-lg md:text-xl lg:text-xl xl-text-2xl cursor-pointer font-semibold">
            ...
            <div className="flex flex-row gap-5">
              ...
              <div className="flex flex-row gap-2 mr-10 cursor-pointer bg-midnightGreen p-2 rounded-full hover:scale-110 hidden md:flex md:items-center">
                <svg
                  fill="currentColor"
                  viewBox="0 0 16 16"
                  height="2em"
        ...
        {isMenuOpen && (
          <div className="font-merriWeather m-0 absolute top-22 left-0 right-0 p-3 gap-4 sm:gap-5 flex flex-col sm:flex-row justify-center z-40 bg-midnightGreen">
